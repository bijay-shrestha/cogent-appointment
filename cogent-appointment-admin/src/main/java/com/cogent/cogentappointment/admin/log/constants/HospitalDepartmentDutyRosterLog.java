...
public class HospitalDepartmentDutyRosterLog {
    ...
    public final static String HOSPITAL_DEPARTMENT_WEEK_DAYS_DUTY_ROSTER = "HOSPITAL DEPARTMENT WEEK DAYS DUTY ROSTER";

    public final static String EXISTING_HOSPITAL_DEPARTMENT_DUTY_ROSTER = "EXISTING HOSPITAL DEPARTMENT DUTY ROSTER";
