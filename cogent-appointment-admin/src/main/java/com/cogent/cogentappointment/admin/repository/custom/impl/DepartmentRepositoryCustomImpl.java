...
public class DepartmentRepositoryCustomImpl implements DepartmentRepositoryCustom {
    ...
    public List<Object[]> validateDuplicity(DepartmentRequestDTO requestDTO) {
        ...
        Query query = QueryUtils.createQuery.apply(entityManager, DepartmentQuery.QUERY_TO_VALIDATE_DUPLICITY)
    ...
    public List<Object[]> validateDuplicity(DepartmentUpdateRequestDTO requestDTO) {
        Query query = QueryUtils.createQuery.apply(entityManager, DepartmentQuery.QUERY_TO_VALIDATE_DUPLICITY_FOR_UPDATE)
    ...
    public List<DepartmentMinimalResponseDTO> search(DepartmentSearchRequestDTO searchRequestDTO,
        ...
        Query query = QueryUtils.createQuery.apply(entityManager, DepartmentQuery.QUERY_TO_SEARCH_DEPARTMENT.apply(searchRequestDTO));
    ...
    public DepartmentResponseDTO fetchDetails(Long id) {
        ...
        Query query = QueryUtils.createQuery.apply(entityManager, DepartmentQuery.QUERY_TO_FETCH_DETAILS)
    ...
    public Optional<List<DropDownResponseDTO>> fetchDepartmentForDropdown() {
        ...
        Query query = QueryUtils.createQuery.apply(entityManager, DepartmentQuery.QUERY_TO_FETCH_DEPARTMENT_FOR_DROPDOWN);
    ...
    public Optional<List<DropDownResponseDTO>> fetchActiveDropDownList() {
        ...
        Query query = QueryUtils.createQuery.apply(entityManager, DepartmentQuery.QUERY_TO_FETCH_ACTIVE_DEPARTMENT_FOR_DROPDOWN);
    ...
    public Optional<List<DropDownResponseDTO>> fetchDepartmentByHospitalId(Long hospitalId) {
        Query query = QueryUtils.createQuery.apply(entityManager, DepartmentQuery.QUERY_TO_FETCH_DEPARTMENT_BY_HOSPITAL_ID)
