...
public class DepartmentServiceImpl implements DepartmentService {
    ...
    public void save(DepartmentRequestDTO requestDTO) {
        ...
        NameAndCodeValidationUtils.validateDuplicity(departments, requestDTO.getName(), requestDTO.getDepartmentCode(),
    ...
    public void update(DepartmentUpdateRequestDTO updateRequestDTO) {
        ...
        NameAndCodeValidationUtils.validateDuplicity(departments, updateRequestDTO.getName(), updateRequestDTO.getDepartmentCode(),
                Department.class.getSimpleName());
