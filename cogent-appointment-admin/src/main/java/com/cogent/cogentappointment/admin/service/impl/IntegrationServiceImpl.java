...
public class IntegrationServiceImpl implements IntegrationService {
    ...
    public List<DropDownResponseDTO> fetchActiveFeatureType() {
        ...
        List<DropDownResponseDTO> responseDTOS = integrationRepository.fetchActiveFeatureType();
    ...
    public List<DropDownResponseDTO> fetchActiveRequestMethod() {
        ...
        List<DropDownResponseDTO> responseDTOS = integrationRepository.fetchActiveRequestMethod();
