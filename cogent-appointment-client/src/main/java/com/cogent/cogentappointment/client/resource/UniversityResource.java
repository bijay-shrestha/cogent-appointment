...
import static com.cogent.cogentappointment.client.constants.SwaggerConstants.UniversityConstant.*;
import static com.cogent.cogentappointment.client.constants.WebResourceKeyConstants.*;
import static com.cogent.cogentappointment.client.constants.WebResourceKeyConstants.UniversityConstants.BASE_UNIVERSITY;
...
public class UniversityResource {
    ...
    public ResponseEntity<?> fetchActiveUniversity() {
        return ok(universityService.fetchActiveMinUniversity());
    }

    @GetMapping(MIN)
    @ApiOperation(FETCH_DETAILS_FOR_DROPDOWN)
    public ResponseEntity<?> fetchUniversity() {
        return ok(universityService.fetchMinUniversity());
    }
}
