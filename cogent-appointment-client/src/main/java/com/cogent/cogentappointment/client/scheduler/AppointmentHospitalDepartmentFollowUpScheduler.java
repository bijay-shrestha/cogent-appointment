...
@EnableScheduling
@Slf4j
public class AppointmentHospitalDepartmentFollowUpScheduler {

    private final AppointmentHospitalDepartmentFollowUpTrackerService appointmentFollowUpTrackerService;

    public AppointmentHospitalDepartmentFollowUpScheduler(
            AppointmentHospitalDepartmentFollowUpTrackerService appointmentFollowUpTrackerService) {
