...
public class QualificationAliasServiceImpl implements QualificationAliasService {
    ...
    public List<DropDownResponseDTO> fetchActiveQualificationAlias() {
        ...
        log.info(CommonLogConstant.FETCHING_PROCESS_STARTED_FOR_DROPDOWN, QUALIFICATION_ALIAS);

        List<DropDownResponseDTO> responseDTOS = qualificationAliasRepository.fetchActiveQualificationAlias();

        log.info(CommonLogConstant.FETCHING_PROCESS_FOR_DROPDOWN_COMPLETED, QUALIFICATION_ALIAS, DateUtils.getDifferenceBetweenTwoTime(startTime));
    ...
    public QualificationAlias fetchQualificationAliasById(Long id) {
        ...
        log.info(CommonLogConstant.FETCHING_PROCESS_STARTED, QUALIFICATION_ALIAS);
        ...
        log.info(CommonLogConstant.FETCHING_PROCESS_COMPLETED, QUALIFICATION_ALIAS, DateUtils.getDifferenceBetweenTwoTime(startTime));
