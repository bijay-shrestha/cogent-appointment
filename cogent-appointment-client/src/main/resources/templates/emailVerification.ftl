                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" class="textContent">
                                                                            ...
                                                                            <div mc:edit="body"
                                                                                ...
                                                                                We received an email change request
                                                                                recently. Please click <b>Confirmation</b>
                                                                                if you have requested.
                                                                                If not, please contact your system
                                                                                administrator.
                                                                            </div>
                                            ...
                                            <tr>
                                                <td style="padding-top:0;" align="center" valign="top" width="500"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="50%"
                                                           class="emailButton" style="background-color: #007bff;">
                                                        <tr>
                                                            <td align="center" valign="middle" class="buttonContent"
                                                                ...
                                                                <#assign verificationURL>${CONFIRMATION_URL}</#assign>
                                                                   href="${verificationURL}">Confirmation</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <!-- // CONTENT TABLE -->
