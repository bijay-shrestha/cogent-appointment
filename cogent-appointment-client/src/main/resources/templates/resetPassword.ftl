                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" class="textContent">
                                                                            ...
                                                                            <div mc:edit="body"
                                                                                ...
                                                                                Your password has been reset. Your new
                                                                                password is :
                                                                            </div>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="50%"
                                                        ...
                                                        <tr>
                                                            <td align="center" valign="middle" class="buttonContent"
                                                                ...
                                                                <h3 mc:edit="header"
                                                                    style="color:#000;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:22px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:center;">
                                                                    <b>${password}</b></h3>
                                                            ...
                                                            <td valign="top" bgcolor="#E1E1E1">
                                                                ...
                                                                <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                                                    <div>Copyright &#169; 2020 <a
                                                                            ...
                                                                            target="_blank"
                                                                            style="text-decoration:none;color:#828282;border-radius:0;"><span
