...
//    }
    ...
    private String getReadableNepaliDate(DateConverterResponeDTO nepaliDateResponse) {
    ...
    public String getReadableNepaliDateFromNepaliDateString(String nepaliDateString){
    ...
    public Integer getCurrentNepaliYear(){
        String[] nepaliDate = (getNepaliDateForDate(new Date())).split("-");
