package com.cogent.cogentthirdpartyconnector.configuration;//package com.cogent.cogentappointment.thirdparty.configuration;
//
...
////                .antMatchers(HttpMethod.POST, "/api/v1/test/post-ticket").permitAll()
