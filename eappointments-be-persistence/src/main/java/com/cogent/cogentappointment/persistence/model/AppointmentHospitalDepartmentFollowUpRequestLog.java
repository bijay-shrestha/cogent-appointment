 ...
 */
@Entity
@Table(name = "appointment_hospital_department_follow_up_request_log")
@Getter
@Setter
public class AppointmentHospitalDepartmentFollowUpRequestLog implements Serializable {
    ...
    @JoinColumn(name = "appointment_hospital_department_follow_up_tracker_id")
    private AppointmentHospitalDepartmentFollowUpTracker appointmentHospitalDepartmentFollowUpTracker;
